    ...
    <div className="bg-home-image">
      <div className="container d-flex align-items-canter ">
        <div className="mt-5 pt-5 pb-5">
          ...
          <h1 className="fw-bold home-title text-light m-0">The Best Way To</h1>
          <h1 className="fw-bold home-title text-light m-0">Success Your</h1>
          <h1 className="fw-bold home-title text-light">Migration And Visa </h1>
          <div className="mt-5">
            ...
            <p className="text-light">
              commodo viverra. Non pulvinar neque laoreet suspendisse interdum.{" "}
            </p>
          </div>
          <div className="orange-btn mt-5">
            <button className="btn orange-btn p-3 px-4 text-light shadow-none">
              Discoverd More
            </button>
          </div>
        </div>
